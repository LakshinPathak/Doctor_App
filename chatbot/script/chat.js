...
var convo = {
  "ice": {
    says: ["Hi! Welcome to Doctor Appointment System ..", "How may I help you?"],
     reply: [
      {
        question: "Need Doctor recommendation",
        answer: "recommend"
      },
      {
        question: "Get Information about a Doctor",
        answer: "info"
      },
      {
  ...
  "book":{
    says: ["Booking facility is not available in DoctoChatbot. In order to book hotels, go to Doctor Appointment website."],
    reply: [
      {question: "Start Over",
        answer: "ice"}
    ]
