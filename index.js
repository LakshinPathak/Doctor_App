...
//const API_KEY = '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'; // Your OpenAI API key
...
app.delete('/deleteUser', async (req, res) => {
    ...
    try {
        ...
        const del_bookapp = await BookedAppointment.findOne({P_name: username });
